defmodule ExKamailio.CallHandler.Server do
  ...
  alias ExKamailio.{Config, Session}
  ...
  defp request(call_id, request) do
    GenServer.call(via(call_id), request, Config.callback_timeout())
  catch
  ...
  defp via(call_id), do: {:via, Registry, {Config.call_registry(), call_id}}
